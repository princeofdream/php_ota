		    ...
		    <div class='divborder'>
		    	<table align='center'>
		    		...
		    		<tr>
		    			...
		    			<td>
		    				<input type='text' readonly="read-only" style="width:250px;height:25px; " value='<?php echo $username;?>'   id='myname'>
						<input type='hidden' value='<?php echo $passsword;?>'   id='oldpassword'>
    ...
    <table  >
        ...
        <td width='260px'></td>
            ...
            <div class='divborder'>
            	<table >
            		...
            		<tr>
            			...
            			<td>
            				<input type='text' style="width:250px;height:25px; " value='<?php echo $username;?>'   id='myname'>
            			</td>
            		</tr>
            		<tr>
            			<td width='100px'></td>
            			...
            			<td>
            				<!-- <input type='text' style="width:250px;height:25px; " value='<?php echo $passsword;?>'  id='mypass'> -->
          ...
          else
          {
          	$height=($nums+2)*40;
          ?>
            <div class='outdivborder' style="height:<?php echo $height;?>px">
            <div class='divborder' style="height:<?php echo $height;?>px">
           <?php
          }
           ?> 	
            	<table >
