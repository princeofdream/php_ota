...
<body>
  ...
  <form onsubmit="UP.start();" target='ifr2'
    action="updeltaresult.php?num=<?php echo $i;?>&deltaversion=<?php echo $version;?>&versionId=<?php echo $versionId;?>&up=<?php echo $upload_path;?>"
    ...
    <table align='center'>
      ...
      <tr>
        <td>
          <table>
            <tr>
              <td><font size='4' color="#3B5998"><b>The current build type is :</b></font><br> <font color="#FF0000" size='2'><b><?php echo $version_str;?></b>
              </font></td>
            </tr>
            <tr>
              <td><font size='4' color="#3B5998"><b>The current build number is :</b></font><br>
              <font color="#FF0000" size='2'><b><?php echo $version;?></b></font></td>
            </tr>
          </table>
        </td>
      </tr>
