...
<body>
  <br>
  <div>
    <form action='edit.php?edit=2&version=<?php echo $version;?>&versionId=<?php echo $versionId;?>' method='post'>
      <table>
        <tr>
          <td width='45%'></td>
          <td height='30px'></td>
            ...
            <table cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td bgcolor="#EBF3FF" width='330px'><input name='version_number' type="text" style="width: 250px; height: 25px;"
                  value='<?phpecho $version;?>' id='version' onchange="change('version','<?php echo $version;?>')" readonly='read-only'></td>
              </tr>
              <tr>
                ...
                <td bgcolor="#EBF3FF" width='330px'><input name='version_name' type="text" style="width: 250px; height: 25px;"
                  value='<?php echo $version_name;?>' id='name' onchange="change('name','<?php echo $version_name;?>')"></td>
              </tr>
              <tr>
                <td width='150px' class='fon2'>Version Size</td>
                <td width='50px' bgcolor="#EBF3FF"></td>
                <td bgcolor="#EBF3FF" width='330px'><input type="text" style="width: 250px; height: 25px;" value='<?php echo $version_size;?>'
                  readonly='read-only'></td>
              </tr>
              <tr>
                <td width='150px' class='fon2'>Version Compress Rate</td>
                <td width='50px' bgcolor="#EBF3FF"></td>
                <td bgcolor="#EBF3FF" width='330px'><input type="text" style="width: 250px; height: 25px;" value='<?php echo $version_compress;?>'
                  readonly='read-only'></td>
              </tr>
              <tr>
                ...
                <td bgcolor="#EBF3FF" width='330px'><textarea cols="33" rows="7" name="releasenotes" id="release notes"
                    onchange="change('release notes','<?php echo $release_notes;?>')"><?php echo $release_notes;?></textarea></td>
              </tr>
              <tr>
                ...
                <td bgcolor="#EBF3FF" width='330px'><textarea cols="33" rows="3" name="androidversion" id="android version"
                    onchange="change('android version','<?php echo $androidversion;?>')"><?php echo $androidversion;?></textarea></td>
              </tr>
              <tr>
                ...
                <td bgcolor="#EBF3FF" width='330px'><textarea cols="33" rows="3" name="fingerprint" id="finger print"
                    onchange="change('finger print','<?php echo $fingerprint;?>')"><?php echo $fingerprint;?></textarea></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td bgcolor="#EBF3FF" width='330px'><input type="text" style="width: 250px; height: 25px;"
                  value='<?php echo date("Y-m-d G:i:s",$release_time);?>' readonly='read-only'></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td bgcolor="#EBF3FF" width='330px'>
                  <div id="timesle">
                    Date:<input readOnly="true" id="date1" name="date1" type="text" onClick="WdatePicker()" value="<?php echo $publish_time;?>"
